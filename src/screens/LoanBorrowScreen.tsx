...
const styles = StyleSheet.create({
  ...
  input: {
    ...
    borderWidth: 1,
    borderColor: '#ccc',
    borderRadius: 25, // Increased border-radius for more curvature
    padding: 10,
    marginVertical: 10,
    backgroundColor: '#fff',
    fontSize: 16,
    elevation: 3, // Shadow effect on inputs for better focus
    shadowColor: '#000',
    shadowOpacity: 0.1,
    shadowRadius: 4,
  },
  button: {
    backgroundColor: 'orange', // Yellow background for the button
    paddingVertical: 12,
    paddingHorizontal: 40,
    borderRadius: 25, // Curved button
    alignItems: 'center',
    justifyContent: 'center',
    marginTop: 20,
